...
public class FuncionarioController {
    ...
    @PutMapping("/funcionario/{id}/assento/{idAssento}")
    public ResponseEntity<FuncionarioRespostaDTO> atualizarFuncionarios(@Valid @PathVariable Long id, @RequestBody FuncionarioRequisicaoDTO funcionario){
