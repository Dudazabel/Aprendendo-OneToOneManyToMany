...
public class FuncionarioController {
    ...
    return ResponseEntity.status(HttpStatus.OK).body(service.associarFuncionarioAssento(idFuncionario, idAssento));
   }

   @PutMapping("/funcionario/{idFuncionario}/projeto/{idProjeto}")
    public ResponseEntity<FuncionarioProjetoRespostaDTO> associarFuncionarioProjeto(@PathVariable Long idFuncionario, @PathVariable Long idProjeto){
    return ResponseEntity.status(HttpStatus.OK).body(service.associarFuncionarioProjeto(idFuncionario, idProjeto));
   }
