...
public class FuncionarioService {
    ...
    public FuncionarioComAssentoRespostaDTO associarFuncionarioAssento(Long idFuncionario, Long idAssento){
        ...
        return FuncionarioMapper.FuncionarioComAssentoRespostaDTO(funcionarioRepository.save(funcionario));
    }
